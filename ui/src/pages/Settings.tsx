...
import { Activity, Server, Database, Settings as SettingsIcon, Code, Terminal, ServerCog, Shield, Plug } from 'lucide-react';
  ...
  return (
    <div className="flex h-full flex-col relative animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        <div className="flex gap-6">
          {tabs.map(tab => (
            <button
              ...
              className={`flex items-center gap-2 pb-4 px-2 border-b-2 transition-colors text-sm font-medium ${
                activeTab === tab.id 
      ...
      <div className="flex-1 p-8 overflow-auto">
        ...
        {activeTab === 'auth' && (
          <div className="max-w-4xl p-8 text-center text-slate-500 border border-slate-800 rounded-xl bg-slate-900/50">
            <Shield size={48} className="mx-auto mb-4 opacity-20" />
            <h3 className="text-lg font-medium text-slate-300 mb-2">Authentication Settings</h3>
            <p>SSO and Identity Provider configuration coming soon.</p>
          </div>
        )}
